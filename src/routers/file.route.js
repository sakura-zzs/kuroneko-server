...
const {uploadMoment,deleteMoment,updateMomentId,uploadComment,deleteComment,updateCommentId,uploadAvatar,uploadSpace,deleteSpace}=require('../controllers/file.controller')
